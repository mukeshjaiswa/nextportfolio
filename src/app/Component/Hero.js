        ...
        <div id='/' className='px-5 sm:px-10 lg:px-15 xl:px-30 py-16 '>
            <div className='flex flex-col md:flex-row items-center justify-between h-80 md:h-100   mt-16   w-full gap-5'>
                ...
                <div   className=' flex-1 '>
                    ...
                    <p data-aos="fade-up" data-aos-duration="2000" className={`${mode == 'dark' ? "text-gray-300" : "text-zinc-600"} text-xl mt-3`} >Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi quibusdam suscipit cum sint vero quia dignissimos reprehenderit quos, facere.</p>
                    <div data-aos="fade-up" data-aos-duration="3000" className='mt-10 flex items-center w-full justify-center gap-3'>
