...
export default function Skill() {
    ...
    return (
        <div id='skill' className='px-5 sm:px-10 lg:px-15 mt-15'>
            <h1 className='text-center font-bold md:text-4xl text-xl'>My Skills</h1>
            <p className='text-center font-light  mt-3'>Technologies I use to build modern web application</p>
            <div className=' mx-10  px-0 sm:px-5 md:px-10 mt-5'>
                <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-16'>
                    {skillsdata.map((items, index) => (
                        <div key={index} className={`  border-2 border-blue-500/30 shadow-[0_0_20px_rgba(59,130,246,0.6)] cursor-pointer flex flex-col justify-center items-center py-5  rounded-xl  transition-all duration-300 hover:border-blue-500 hover:shadow-[0_0_25px_rgba(59,130,246,0.7)]`}>
